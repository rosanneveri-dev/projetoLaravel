...
<!-- Modal Structure -->
   <div id="create" class="modal">
    <div class="modal-content">
      ...
      <form action ="{{route('admin.store')}}" method="POST" enctype="multipart/form-data" class="col s12">
        @csrf
        ...
        <div class="row">
          ...
          <div class="input-field col s6">
            <input name="nome" placeholder="Produto" id="nome" type="text" class="validate">
