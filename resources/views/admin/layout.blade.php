...
<body>
    ...
    <ul id="slide-out" class="sidenav " >
      <li><div class="user-view">
        <div class="background red ">
         <img src="{{asset('img/.jpg')}}" style="opacity: 0.5"> 
        </div>
          <a href="#user"><img class="circle" src="{{asset('img/office.jpg')}}"></a>
          <a href="#name"><span class="white-text name">John Doe</span></a>
          <a href="#email"><span class="white-text email">jdandturk@gmail.com</span></a>
       </div></li> 

        <li><a href="{{route('admin.dashboard')}}}"><i class="material-icons">dashboard</i>Dashboard</a></li>
        <li><a href="{{route('admin.dashboard')}}"><i class="material-icons">playlist_add_circle</i>Produtos</a></li>
    ...
    {{--biblioteca que gera os graficos--}}
